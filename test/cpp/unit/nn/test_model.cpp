...
TEST(TestModel, TestInitModelFromConfigGC) {
    int feature_dim = 50;
    int random_seed = 100;
    ...
    model_config->random_seed = random_seed;
    model_config->learning_task = LearningTask::GRAPH_CLASSIFICATION;
    ...
    // check learning task
    ASSERT_EQ(model->learning_task_, LearningTask::GRAPH_CLASSIFICATION);
